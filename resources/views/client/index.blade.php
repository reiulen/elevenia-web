<x-app-layout title="Client">
    <x-content_header>
        ...
        <x-breadcrumb>
            ...
            <li class="breadcrumb-item item">{{ __('Client') }}</li>
        </x-breadcrumb>
    </x-content_header>
    <!-- Main content -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-header card-outline">
                            <a class="btn btn-primary border-0 btn-tambah"><i class="fa fa-plus px-1"></i> Add Client</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                ...
                <div class="col-md-5 form-inputan" style="display: none">
                    <div class="card">
                        <div class="card-header card-outline">
                            <h3 class="card-title">Inputan Client</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
